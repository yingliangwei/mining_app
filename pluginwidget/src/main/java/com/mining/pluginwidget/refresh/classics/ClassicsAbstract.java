package com.mining.pluginwidget.refresh.classics;
...
public abstract class ClassicsAbstract<T extends ClassicsAbstract<?>> extends SimpleComponent implements RefreshComponent {
    ...
    public T setAccentColor(int accentColor) {
        ...
        if (mArrowDrawable != null) {
            mArrowDrawable.setColorFilter(accentColor, PorterDuff.Mode.SRC_IN);
            mArrowView.invalidateDrawable(mArrowDrawable);
        }
        if (mProgressDrawable != null) {
            mProgressDrawable.setColorFilter(accentColor, PorterDuff.Mode.SRC_IN);
    ...
    public T setPrimaryColorId(int colorId) {
        final View thisView = this;
        setPrimaryColor(thisView.getContext().getResources().getColor(colorId));
        return self();
    }

    public T setAccentColorId(int colorId) {
        final View thisView = this;
        setAccentColor(thisView.getContext().getResources().getColor(colorId));
        return self();
    }
