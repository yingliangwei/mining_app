...
public class StatusBarUtil {
    ...
    public static void setImmersiveStatusBar(Activity activity, boolean fontIconDark) {
        ...
        if (fontIconDark) {
            ...
            } else if (OSUtils.isFlyme()) setStatusBarFontIconDark(activity, TYPE_FLYME);
     ...
     * 界面设置状态栏字体颜色
     */
    public static void changeStatusBarTextImgColor(Window window, boolean isBlack) {
        if (isBlack) {
            //设置状态栏黑色字体
    ...
    public static void setImmersive(Activity activity, boolean fontIconDark) {
        if (fontIconDark) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                setStatusBarFontIconDark(activity, TYPE_M);
            } else if (OSUtils.isMiui()) {
