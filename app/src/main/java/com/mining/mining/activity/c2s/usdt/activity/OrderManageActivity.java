...
import com.mining.mining.activity.c2s.usdt.activity.pager.OrderManagePager;
import com.mining.mining.adapter.PagerAdapter;
import com.mining.mining.adapter.RecyclerAdapter;
import com.mining.mining.databinding.ActivityOrderManageUsdtBinding;
...
public class OrderManageActivity extends AppCompatActivity implements TabLayout.OnTabSelectedListener {
    private ActivityOrderManageUsdtBinding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = ActivityOrderManageUsdtBinding.inflate(getLayoutInflater());
    ...
    private void initTab() {
        binding.tab.addTab(binding.tab.newTab().setText("买入").setId(0));
