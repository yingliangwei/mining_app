...
public class UsdtBillAdapter extends RecyclerView.Adapter<UsdtBillAdapter.ViewHolder> {
    private final Context context;
    private final List<UsdtBillEntity> list;
    private View mEmptyTextView;

    public UsdtBillAdapter(Context context, List<UsdtBillEntity> list) {
